    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#374151] mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-[#374151] hover:text-[#0EA5E9] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-[#374151] hover:text-[#0EA5E9] transition-colors">
                  Login
                </Link>
              </li>
              <li>
                <a href="#" className="text-[#374151] hover:text-[#0EA5E9] transition-colors">
                  Find a Doctor
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#374151] mb-4">Contact Us</h3>
